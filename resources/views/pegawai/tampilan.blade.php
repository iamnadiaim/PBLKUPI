...
<body>
  ...
  <div class="mb-3 d-flex justify-content-between align-items-start">
    <div class="margin-left mr-auto">
      ...
      <div class="dropdown">
      <a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: transparent; border: none; text-decoration: none; color: black; ">
...
Activity
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: max-content; background-color: whitesmoke; position: fixed;max-height: 300px; overflow-y: auto;">
    <p style="text-align: center; font-size: large; margin-bottom: -5px; padding-top: 10px; color: black;"><b>Activity Pegawai</b></p>
